...
enum class FeatureCategory {
    ...
    COURSE_LIST, MANAGE_STUDENTS, COURSE_BROWSER, ALERTS, ACCOUNT_CREATION, COURSE_DETAILS, CUSTOM_STATUSES
}
...
enum class SecondaryFeatureCategory {
    ...
    SYLLABUS, SUMMARY, FRONT_PAGE, CANVAS_NETWORK, INBOX_SIGNATURE, ACCESS_TOKEN_EXPIRATION, SECTIONS, HELP_MENU
}
