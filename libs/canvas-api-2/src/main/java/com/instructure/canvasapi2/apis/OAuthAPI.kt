...
object OAuthAPI {
    ...
    interface OAuthInterface {
        ...
        fun getAuthenticatedSession(@Query("return_to") targetUrl: String, @Query("mobile_consent") mobileConsent: Boolean = ApiPrefs.mobileConsent == false): Call<AuthenticatedSession>

        @GET("/login/session_token")
        suspend fun getAuthenticatedSession(@Query("return_to") targetUrl: String, @Tag params: RestParams, @Query("mobile_consent") mobileConsent: Boolean = ApiPrefs.mobileConsent == false): DataResult<AuthenticatedSession>
