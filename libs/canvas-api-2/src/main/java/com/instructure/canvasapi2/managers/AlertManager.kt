...
object AlertManager {
    ...
    @JvmStatic
    fun getObserverAlerts(studentId: Long, forceNetwork: Boolean, callback: StatusCallback<List<ObserverAlert>>) {
    ...
    @JvmStatic
    fun updateObserverAlert(alertId: Long, workflowState: String, callback: StatusCallback<ObserverAlert>) {
        val adapter = RestBuilder(callback)
