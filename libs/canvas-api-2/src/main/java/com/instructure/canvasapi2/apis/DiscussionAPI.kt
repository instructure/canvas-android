...
object DiscussionAPI {
    ...
    interface DiscussionInterface {
        ...
        suspend fun markAllDiscussionTopicEntriesRead(@Path("contextType") contextType: String, @Path("contextId") contextId: Long, @Path("topicId") topicId: Long, @Tag params: RestParams): DataResult<Unit>
