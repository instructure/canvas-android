...
abstract class CanvasPact : ConsumerPactTest() {
    ...
    companion object {
        ...
        const val consumerName = "Android Parent"
    }

    override fun providerName(): String = providerName
    override fun consumerName(): String = consumerName

    fun getParams(mockServer: MockServer): RestParams = RestParams(domain = mockServer.getUrl())
    ...
    override fun getSpecificationVersion(): PactSpecVersion = PactSpecVersion.V2
}
