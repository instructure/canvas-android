...
class GetCourse : CanvasPact() {
    ...
    override fun createPact(builder: PactDslWithProvider): RequestResponsePact {
        val body = PactDslJsonBody()
                ...
                .asBody()
        return builder
                .given("a teacher enrolled in a course")
                .uponReceiving("a get request for the course as a teacher")
                .method("GET")
                ...
                .headers(mapOf(Pair("Authorization", "Bearer some_token")))//, Pair("Auth-user", "Teacher1")))  Can't change Auth-user yet
                .willRespondWith()
                .status(200)
                .body(body)
