...
class GetUnreadCommentsCountUseCase @Inject constructor(
    private val repository: CommentsRepository,
) : BaseUseCase<GetUnreadCommentsCountUseCase.Params, Int>() {
    ...
    override suspend fun execute(params: Params): Int {
        return repository.getUnreadCommentCount(params.assignmentId, params.userId, params.forceNetwork)
    }
}