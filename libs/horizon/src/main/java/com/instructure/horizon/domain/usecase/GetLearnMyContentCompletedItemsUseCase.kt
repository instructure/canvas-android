...
private const val QUERY_KEY = "COMPLETED"

data class GetLearnMyContentCompletedItemsParams(
    val cursor: String?,
...
class GetLearnMyContentCompletedItemsUseCase @Inject constructor(
    private val repository: LearnMyContentRepository,
) : BaseUseCase<GetLearnMyContentCompletedItemsParams, LearnItemsResponse>() {

    override suspend fun execute(params: GetLearnMyContentCompletedItemsParams): LearnItemsResponse {
