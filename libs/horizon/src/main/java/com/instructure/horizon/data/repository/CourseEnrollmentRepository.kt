...
class CourseEnrollmentRepository @Inject constructor(
    private val networkDataSource: CourseEnrollmentNetworkDataSource,
    private val localDataSource: CourseEnrollmentLocalDataSource,
