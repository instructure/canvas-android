...
/**
 * Flattened entity for [com.instructure.canvasapi2.models.journey.learninglibrary.LearningLibraryCollectionItem]
 * belonging to an enrolled collection (Browse tab).
 */
@Entity(
    tableName = "horizon_learn_collection_items",
    indices = [Index("collectionId")]
)
data class HorizonLearnCollectionItemEntity(
