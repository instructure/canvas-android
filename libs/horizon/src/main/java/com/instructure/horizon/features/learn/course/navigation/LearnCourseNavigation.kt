...
@Composable
fun LearnCourseNavigation(mainNavController: NavHostController) {
    ...
    NavHost(
        ...
        composable(
            route = LearnCourseRoute.LearnCourseListRoute.route
        ) {
            LearnCourseListScreen()
        }
        composable(
            route = LearnCourseRoute.LearnCourseDetailsRoute.route,
        ) {
            TODO()
        }
    }
