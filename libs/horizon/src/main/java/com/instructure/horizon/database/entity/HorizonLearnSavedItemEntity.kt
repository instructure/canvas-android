...
/**
 * Flattened entity for bookmarked [com.instructure.canvasapi2.models.journey.learninglibrary.LearningLibraryCollectionItem]
 * items (Saved tab).
 */
@Entity(tableName = "horizon_learn_saved_items")
data class HorizonLearnSavedItemEntity(
