...
public abstract class SyncExpandableFragment<
        GROUP,
        ...
        ADAPTER extends SyncExpandableRecyclerAdapter<GROUP, MODEL, HOLDER>> extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(LOADER_ID, null, new LoaderManager.LoaderCallbacks<PRESENTER>() {
            ...
            public final void onLoadFinished(Loader<PRESENTER> loader, PRESENTER presenter) {
                if (!mDelivered) {
                    SyncExpandableFragment.this.mPresenter = presenter;
                    mDelivered = true;
            ...
            public final void onLoaderReset(Loader<PRESENTER> loader) {
                SyncExpandableFragment.this.mPresenter = null;
