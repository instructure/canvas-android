...
public class AppMsg {
	...
	public static int styleToInt(AppMsg.Style style)
	{
		if (style == STYLE_ERROR)
			return 0;
		else if (style == STYLE_SUCCESS)
			return 1;
		else 
			return 2;
	}
	
	public static AppMsg.Style intToStyle(int style)
	{
		if (style == 0)
			return STYLE_ERROR;
		else if (style == 1)
	 ...
	 */
	public static final Style STYLE_ERROR = new Style(LENGTH_LONG, R.color.alert);
	
	/**
	 * Show the text notification for a short period of time with a positive style.
	 */
	public static final Style STYLE_WARNING = new Style(LENGTH_SHORT, R.color.confirm);
	
	/**
	 * Show the text notification for a short period of time with a neutral style.
	 */
	public static final Style STYLE_SUCCESS = new Style(LENGTH_SHORT, R.color.info);
