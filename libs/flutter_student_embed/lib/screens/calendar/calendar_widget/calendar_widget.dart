...
class CalendarWidget extends StatefulWidget {
  ...
  final Function(bool isTodaySelected) onTodaySelected;
...
class CalendarWidgetState extends State<CalendarWidget> with TickerProviderStateMixin {
                        ...
                        child: ValueListenableBuilder(
                          builder: (BuildContext context, value, Widget child) {
                            return DropdownArrow(
                                specificProgress: value, color: StudentTheme.of(context).onSurfaceColor);
                          },
  ...
  void selectDay(
    ...
    widget.onTodaySelected(selectedDay.isSameDayAs(DateTime.now()));
