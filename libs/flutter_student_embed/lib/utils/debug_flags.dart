...
/// git update-index --skip-worktree libs/flutter_student_embed/lib/utils/debug_flags.dart
///
/// To start tracking local changes again, run this command:
/// git update-index --no-skip-worktree libs/flutter_student_embed/lib/utils/debug_flags.dart
class DebugFlags {
