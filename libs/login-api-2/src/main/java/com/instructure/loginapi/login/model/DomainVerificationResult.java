...
public class DomainVerificationResult implements Parcelable {
    ...
    protected DomainVerificationResult(Parcel in) {
    ...
    public static final Parcelable.Creator<DomainVerificationResult> CREATOR = new Parcelable.Creator<DomainVerificationResult>() {
        @Override
        public DomainVerificationResult createFromParcel(Parcel source) {
            return new DomainVerificationResult(source);
        }

        @Override
        public DomainVerificationResult[] newArray(int size) {
            return new DomainVerificationResult[size];
        }
    };
}
