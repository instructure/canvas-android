...
class WidgetMetadataDaoTest {
    ...
    fun upsertMetadata_insertsNewEntity() = runTest {
        val entity = WidgetMetadataEntity("widget1", 0, true, true)
    ...
    fun upsertMetadata_updatesExistingEntity() = runTest {
        val entity1 = WidgetMetadataEntity("widget1", 0, true, true)
        dao.upsertMetadata(entity1)

        val entity2 = WidgetMetadataEntity("widget1", 1, false, false)
