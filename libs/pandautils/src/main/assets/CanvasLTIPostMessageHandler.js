    ...
    switch (subject) {
      ...
      case 'requestFullWindowLaunch':
        ...
        if (typeof CanvasStudioInterface !== 'undefined' && CanvasStudioInterface !== null) {
          ...
          CanvasStudioInterface.handleFullWindowLaunch(JSON.stringify(message));
        } else if (typeof webkit !== 'undefined' && webkit.messageHandlers && webkit.messageHandlers.fullWindowLaunch) {
          // iOS
          console.log('[Canvas Mobile LTI] Using iOS interface');
          webkit.messageHandlers.fullWindowLaunch.postMessage(message);
        } else {
          console.error('[Canvas Mobile LTI] No platform interface available for fullWindowLaunch');
        }
        return;
      default:
