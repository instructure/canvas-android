...
data class CourseSyncSettingsEntity(
    ...
    companion object {
        val TABS = setOf(Tab.ASSIGNMENTS_ID, Tab.PAGES_ID, Tab.GRADES_ID, Tab.SYLLABUS_ID, Tab.ANNOUNCEMENTS_ID, Tab.DISCUSSIONS_ID, Tab.CONFERENCES_ID, Tab.MODULES_ID)
    }
}