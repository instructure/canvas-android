...
class SaveWidgetMetadataUseCase @Inject constructor(
    private val repository: WidgetMetadataRepository
) : BaseUseCase<WidgetMetadata, Unit>() {

    override suspend fun execute(params: WidgetMetadata) {
        repository.saveMetadata(params)
    }
}