...
val appDatabaseMigrations = arrayOf(
    ...
    createMigration(10, 11) { database ->
        database.execSQL("CREATE TABLE IF NOT EXISTS assignment_filter (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, userDomain TEXT NOT NULL, userId INTEGER NOT NULL, contextId INTEGER NOT NULL, groupId INTEGER NOT NULL, selectedIndexes TEXT NOT NULL)")
    }
)
