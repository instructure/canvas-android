...
class UpdateWidgetPositionUseCase @Inject constructor(
    private val repository: WidgetMetadataRepository
) : BaseUseCase<UpdateWidgetPositionUseCase.Params, Unit>() {

    override suspend fun execute(params: Params) {
        repository.updatePosition(params.widgetId, params.position)
    }
