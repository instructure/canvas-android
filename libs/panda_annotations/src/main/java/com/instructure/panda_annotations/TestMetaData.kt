...
enum class FeatureCategory {
    ASSIGNMENTS, SUBMISSIONS, LOGIN, COURSE, DASHBOARD, SETTINGS, PAGES, DISCUSSIONS, MODULES,
    INBOX, GRADES, FILES, EVENTS, PEOPLE, CONFERENCES, COLLABORATIONS, SYLLABUS, TODOS, NONE
}
