...
import com.emeritus.student.adapter.CanvasContextSpinnerAdapter
import com.emeritus.student.adapter.NothingSelectedSpinnerAdapter
import com.emeritus.student.dialog.UnsavedChangesExitDialog
import com.emeritus.student.events.ChooseRecipientsEvent
import com.emeritus.student.events.ConversationUpdatedEvent
import com.emeritus.student.events.MessageAddedEvent
        ...
        contactsImageButton.onClick {
            if (selectedContext == null && conversation == null) {
                ...
                RouteMatcher.route(requireContext(),
                    InboxRecipientsFragment.makeRoute(canvasContext, chips.recipients)
                )
            }
        }
