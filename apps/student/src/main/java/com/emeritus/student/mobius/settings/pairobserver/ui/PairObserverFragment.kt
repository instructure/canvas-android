 ...
 *
 */
package com.emeritus.student.mobius.settings.pairobserver.ui
...
import com.emeritus.student.mobius.settings.pairobserver.*

@ScreenView(SCREEN_VIEW_PAIR_OBSERVER)
class PairObserverFragment :
    MobiusFragment<PairObserverModel, PairObserverEvent, PairObserverEffect, PairObserverView, PairObserverViewState>() {
    ...
    override fun makeView(inflater: LayoutInflater, parent: ViewGroup) =
        PairObserverView(inflater, parent)
