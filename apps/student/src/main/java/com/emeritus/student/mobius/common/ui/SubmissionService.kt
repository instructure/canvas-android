 ...
 *
 */
package com.emeritus.student.mobius.common.ui
...
class SubmissionService : IntentService(SubmissionService::class.java.simpleName) {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        lateinit var submission: com.emeritus.student.Submission
    ...
    private fun uploadText(db: StudentDb, submission: com.emeritus.student.Submission) {
    ...
    private fun uploadUrl(db: StudentDb, submission: com.emeritus.student.Submission, isLti: Boolean) {
        showProgressNotification(submission.assignmentName, submission.id)
    ...
    private fun uploadMedia(db: StudentDb, submission: com.emeritus.student.Submission) {
        showProgressNotification(submission.assignmentName, submission.id)
    ...
    private fun uploadFileSubmission(db: StudentDb, submission: com.emeritus.student.Submission) {
        showProgressNotification(submission.assignmentName, submission.id)
    ...
    private fun uploadFiles(submission: com.emeritus.student.Submission, completedAttachmentCount: Int, attachments: List<FileSubmission>, db: StudentDb): List<Long>? {
    ...
    private fun uploadStudentAnnotation(db: StudentDb, submission: com.emeritus.student.Submission) {
        showProgressNotification(submission.assignmentName, submission.id)
    ...
    private fun handleFileError(db: StudentDb, submission: com.emeritus.student.Submission, completedCount: Int, attachments: List<FileSubmission>, errorMessage: String?) {
        if (db.submissionQueries.getSubmissionById(submission.id).executeAsOneOrNull() == null) {
    ...
    private fun showErrorNotification(
        context: Context,
        submission: com.emeritus.student.Submission
    ) {
