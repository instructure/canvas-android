...
import com.emeritus.student.adapter.DashboardRecyclerAdapter
import com.emeritus.student.decorations.VerticalGridSpacingDecoration
import com.emeritus.student.dialog.ColorPickerDialog
import com.emeritus.student.dialog.EditCourseNicknameDialog
import com.emeritus.student.events.CoreDataFinishedLoading
import com.emeritus.student.events.CourseColorOverlayToggledEvent
import com.emeritus.student.events.ShowGradesToggledEvent
...
class DashboardFragment : ParentFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        recyclerAdapter = DashboardRecyclerAdapter(requireActivity(), object :
