...
import com.emeritus.student.activity.*
...
//        bottomSheetFragments.add(EditFavoritesFragment::class.java)
    ...
    fun route(context: Context, route: Route?) {
        ...
        } else if (route.routeContext == RouteContext.FILE || route.primaryClass?.isAssignableFrom(
                FileListFragment::class.java) == true && route.queryParamsHash.containsKey(RouterParams.PREVIEW)) {
            when {
