...
import com.emeritus.student.events.PageUpdatedEvent
import com.emeritus.student.router.RouteMatcher
import com.emeritus.student.util.LockInfoHTMLHelper
...
class PageDetailsFragment : InternalWebviewFragment(), Bookmarkable {
    ...
    companion object {
        ...
        fun makeRoute(canvasContext: CanvasContext, page: Page): Route {
            return Route(null, PageDetailsFragment::class.java, canvasContext, canvasContext.makeBundle(Bundle().apply { putParcelable(
                PAGE, page) }))
        }
    }
}
