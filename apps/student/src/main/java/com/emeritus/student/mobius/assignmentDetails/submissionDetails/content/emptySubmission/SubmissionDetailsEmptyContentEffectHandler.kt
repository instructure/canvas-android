...
import com.emeritus.student.mobius.assignmentDetails.*
...
import com.emeritus.student.mobius.assignmentDetails.submissionDetails.content.emptySubmission.ui.SubmissionDetailsEmptyContentView
...
class SubmissionDetailsEmptyContentEffectHandler(val context: Context, val assignmentId: Long) :
    ...
    override fun accept(effect: SubmissionDetailsEmptyContentEffect) {
        when (effect) {
            SubmissionDetailsEmptyContentEffect.ShowVideoRecordingView -> context.launchVideo({
                SubmissionDetailsEmptyContentEvent.StoreVideoUri(
                    it
                )
            }, { view?.showPermissionDeniedToast() }, consumer, SubmissionDetailsEmptyContentFragment.VIDEO_REQUEST_CODE)
