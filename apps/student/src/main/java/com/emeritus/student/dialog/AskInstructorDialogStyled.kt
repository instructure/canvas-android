...
import com.emeritus.student.dialog.FatalErrorDialogStyled.Companion.newInstance
...
class AskInstructorDialogStyled : DialogFragment() {
    ...
    private fun sendMessage() {
        ...
        tryWeave {
            ...
            fatalErrorDialog.show(requireActivity().supportFragmentManager,
                FatalErrorDialogStyled.TAG
            )
        }
    }
