 ...
 *
 */
package com.emeritus.student.mobius.assignmentDetails.submissionDetails.drawer.comments
...
object SubmissionCommentsPresenter :
    Presenter<SubmissionCommentsModel, SubmissionCommentsViewState> {
    ...
    override fun present(model: SubmissionCommentsModel, context: Context): SubmissionCommentsViewState {
        val self = ApiPrefs.user ?: return SubmissionCommentsViewState(false, listOf(
            CommentItemState.Empty))
