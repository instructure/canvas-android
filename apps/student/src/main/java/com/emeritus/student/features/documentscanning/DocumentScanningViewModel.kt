...
package com.emeritus.student.features.documentscanning
...
import com.emeritus.student.features.documentscanning.itemviewmodels.FilterItemViewModel
...
class DocumentScanningViewModel @Inject constructor(
    ...
    fun onSaveClicked() {
        _events.postValue(Event(
            DocumentScanningAction.SaveBitmapAction(
                selectedItem.data.bitmap,
                100
            )
        ))
    }
