...
object FileUtils {
    ...
    fun getFileIcon(filename: String, contentType: String): Int {
        return when {
            contentType.startsWith("image") -> R.drawable.ic_utils_image
            contentType.startsWith("video") -> R.drawable.ic_utils_media
            contentType.startsWith("audio") -> R.drawable.ic_utils_audio
            else -> when (filename.substringAfterLast(".")) {
                "doc", "docx", "txt", "rtf", "pdf", "xls" -> R.drawable.ic_utils_document
