 ...
 *
 */
package com.instructure.student.mobius.assignmentDetails.submissions.file
...
object UploadStatusSubmissionPresenter :
    Presenter<com.instructure.student.mobius.assignmentDetails.submissions.file.UploadStatusSubmissionModel, UploadStatusSubmissionViewState> {

    override fun present(
        model: com.instructure.student.mobius.assignmentDetails.submissions.file.UploadStatusSubmissionModel,
        context: Context
    ): UploadStatusSubmissionViewState {
        return when {
            model.isFailed -> com.instructure.student.mobius.assignmentDetails.submissions.file.UploadStatusSubmissionPresenter.presentFailed(
                model,
                context
            )
            model.isLoading -> UploadStatusSubmissionViewState.Loading
            model.files.isEmpty() -> com.instructure.student.mobius.assignmentDetails.submissions.file.UploadStatusSubmissionPresenter.presentSuccess(
                context
            )
            else -> com.instructure.student.mobius.assignmentDetails.submissions.file.UploadStatusSubmissionPresenter.presentInProgress(
                model,
                context
            )
        }
    ...
    private fun presentFailed(
        ...
        return UploadStatusSubmissionViewState.Failed(
            ...
            com.instructure.student.mobius.assignmentDetails.submissions.file.UploadStatusSubmissionPresenter.presentListItems(
                model,
                context,
