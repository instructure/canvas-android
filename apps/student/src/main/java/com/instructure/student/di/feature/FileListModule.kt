...
class FileListModule {
    ...
    @Provides
    fun provideNetworkDataSource(fileFolderApi: FileFolderAPI.FilesFoldersInterface): FileListNetworkDataSource {
        return FileListNetworkDataSource(fileFolderApi)
    }

    @Provides
    fun provideLocalDataSource(fileFolderDao: FileFolderDao, localFileDao: LocalFileDao): FileListLocalDataSource {
        return FileListLocalDataSource(fileFolderDao, localFileDao)
    }

    @Provides
    fun provideFileListRepository(
