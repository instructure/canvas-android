...
sealed class SubmissionDetailsContentType {
    ...
    data class ExternalToolContent(val canvasContext: CanvasContext, val url: String, val title: String, val internalLti: Boolean = false) : SubmissionDetailsContentType()
