...
class SettingsE2ETest : StudentComposeTest() {
    ...
    fun testProfileSettingsE2E() {
        ...
        Log.d(ASSERTION_TAG, "Assert that the Profile Settings Page has been displayed correctly.")
        ...
        Log.d(ASSERTION_TAG, "Assert that the Dashboard Page has been displayed correctly.")
        leftSideNavigationDrawerPage.assertUserLoggedIn(newUserName)

        val originalSavedPandaAvatarCount = getSavedPandaAvatarCount()
        Log.d(STEP_TAG, "Navigate to Settings Page again.")
        leftSideNavigationDrawerPage.clickSettingsMenu()

        Log.d(ASSERTION_TAG, "Assert that the Settings Page has been displayed correctly.")
        settingsPage.assertPageObjects()

        Log.d(STEP_TAG, "Navigate to Profile Settings Page.")
        settingsPage.clickOnSettingsItem("Profile Settings")

        Log.d(ASSERTION_TAG, "Assert that the Profile Settings Page has been displayed correctly.")
        profileSettingsPage.assertPageObjects()

        Log.d(STEP_TAG, "Open Panda Avatar Creator.")
    ...
    fun testLegalPageE2E() {
        ...
        Log.d(STEP_TAG, "Click on 'Legal' link to open Legal Page.")
        settingsPage.clickOnSettingsItem("Legal")

        Log.d(ASSERTION_TAG, "Assert that the Legal Page has been displayed correctly.")
    ...
    fun testAboutE2E() {
        ...
        Log.d(ASSERTION_TAG, "Assert that the About Page has been displayed correctly.")
        aboutPage.assertPageObjects()

        Log.d(ASSERTION_TAG, "Check that domain is equal to: '${student.domain}' (student's domain).")
        aboutPage.domainIs(student.domain)

        Log.d(ASSERTION_TAG, "Check that Login ID is equal to: '${student.loginId}' (student's Login ID).")
        aboutPage.loginIdIs(student.loginId)

        Log.d(ASSERTION_TAG, "Check that e-mail is equal to: '${student.loginId}' (student's Login ID).")
    ...
    fun testSubscribeToCalendar() {
        ...
        Log.d(ASSERTION_TAG, "Assert that the proper intents has launched, so the NavigationActivity has been launched with an Intent from SettingsActivity.")
    ...
    fun testPronounsE2E() {
        ...
        Log.d(ASSERTION_TAG, "Assert that the corresponding user info, so does the 'Pronoun Student (She/Her)' as username and 'pronounstudent@gmail.com' as user email are displayed.")
        ...
        Log.d(ASSERTION_TAG, "Assert that the People List Page has been displayed correctly.")
        peopleListPage.assertPageObjects()

        Log.d(ASSERTION_TAG, "Assert that the '$testPronoun' pronouns are displayed next to the 'Pronoun Student' user's name.")
        ...
        Log.d(ASSERTION_TAG, "Assert on the Login Landing Page that the '$testPronoun' pronouns are displayed besides the 'Pronoun Student' user's name.")
