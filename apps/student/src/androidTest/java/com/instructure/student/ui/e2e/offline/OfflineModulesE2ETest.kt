...
class OfflineModulesE2ETest : StudentTest() {
    ...
    fun testOfflineModulesE2E() {
        ...
        Log.d(STEP_TAG, "Assert that the Offline Indicator (bottom banner) is displayed on the Module List Page.")
        assertOfflineIndicator()

        Log.d(STEP_TAG,"Assert that '${testModule1.name}' module is displayed with the following items: '${testAssignment1.name}' assignment, '${testQuiz.title}' quiz.")
        ...
        Log.d(STEP_TAG,"Assert that '${testModule2.name}' module is displayed with the following items: '${testAssignment2.name}' assignment," +
        ...
        Log.d(STEP_TAG, "Collapse the '${testModule2.name}' module. Assert that there will be 4 countable items on the screen.")
        ...
        Log.d(STEP_TAG, "Expand the '${testModule2.name}' module. Assert that there will be 7 countable items on the screen.")
        modulesPage.clickOnModuleExpandCollapseIcon(testModule2.name)
        modulesPage.assertModulesAndItemsCount(7) // 2 modules titles, 2 module items in first module, 3 items in second module

        Log.d(STEP_TAG, "Assert that '${testAssignment1.name}' module item is displayed and open it.")
        ...
        Log.d(STEP_TAG, "Assert that the 'Not Available Offline' content is displayed.")
        ...
        Log.d(STEP_TAG, "Click on the next arrow button and assert that the '${testQuiz.title}' quiz module item's 'Go To Quiz' page is displayed.")
        assignmentDetailsPage.moduleItemInteractions.clickOnNextArrow()
        goToQuizPage.assertQuizTitle(testQuiz.title)

        Log.d(STEP_TAG, "Click on the 'Go To Quiz' button and assert that the 'No Internet Connection' dialog is displayed. Dismiss the dialog.")
        ...
        Log.d(STEP_TAG, "Click on the next arrow button and assert that the Assignment Details Page is displayed with the corresponding assignment name: '${testAssignment2.name}'.")
        ...
        Log.d(STEP_TAG, "Assert that the second module name, '${testModule2.name}' is displayed at the bottom since we can navigate even between modules with these arrows.")
        ...
        Log.d(STEP_TAG, "Click on the next arrow button and assert that the '${testDiscussionTopic.title}' discussion topic module item's details page is displayed.")
        assignmentDetailsPage.moduleItemInteractions.clickOnNextArrow()
        ...
        Log.d(STEP_TAG, "Assert that the second module name, '${testModule2.name}' is displayed at the bottom.")
        ...
        Log.d(STEP_TAG, "Click on the next arrow button and assert that the '${testPage.url}' page module item's details page is displayed.")
