...
class OfflineSyncSettingsE2ETest : StudentComposeTest() {
    ...
    fun offlineSyncSettingsE2ETest() {
        ...
        Log.d(ASSERTION_TAG, "Assert that the Offline Sync Settings related information is displayed properly on the Settings Page ('Daily' is the default status).")
        ...
        Log.d(ASSERTION_TAG, "Assert that further settings, such as the toolbar title is displayed and correct, and both the Auto Content Sync and Wi-Fi Only Sync toggles are displayed and checked by default.")
        ...
        Log.d(ASSERTION_TAG, "Assert that all the descriptions of how these settings are working are displayed.")
        offlineSyncSettingsPage.assertSyncSettingsPageDescriptions()

        Log.d(ASSERTION_TAG, "Assert that the sync frequency label is 'Daily', because that is the default setting.")
        offlineSyncSettingsPage.assertSyncFrequencyLabelText(R.string.daily)

        Log.d(STEP_TAG, "Switch off the 'Auto Content Sync' toggle.")
        offlineSyncSettingsPage.clickAutoSyncSwitch()

        Log.d(ASSERTION_TAG, "Assert that further settings, such as the toolbar title, Auto Content Sync and Wi-Fi Only Sync toggles are NOT displayed.")
        offlineSyncSettingsPage.assertFurtherSettingsNotDisplayed()

        Log.d(STEP_TAG, "Switch back the 'Auto Content Sync' toggle.")
        offlineSyncSettingsPage.clickAutoSyncSwitch()

        Log.d(ASSERTION_TAG, "Assert that further settings, such as the toolbar title is displayed and correct, and both the Auto Content Sync and Wi-Fi Only Sync toggles are displayed again.")
        offlineSyncSettingsPage.assertFurtherSettingsIsDisplayed()

        Log.d(STEP_TAG, "Switch off the 'Sync Content Wi-Fi Only' toggle.")
        offlineSyncSettingsPage.clickWifiOnlySwitch()

        Log.d(ASSERTION_TAG, "Assert that the confirmation dialog is displayed with the proper texts.")
        ...
        Log.d(ASSERTION_TAG, "Assert that the 'Sync Content Wi-Fi Only' switch is not checked any more.")
        ...
        Log.d(ASSERTION_TAG, "Assert that the sync frequency label became 'Weekly' (without any manual refresh).")
        ...
        Log.d(ASSERTION_TAG, "Assert that the Offline Sync Settings frequency text is 'Weekly' (because we set it previously).")
        settingsPage.assertOfflineSyncSettingsStatus("Weekly")

        Log.d(STEP_TAG, "Open Offline Sync Settings page and wait for it to be loaded.")
        settingsPage.clickOnSettingsItem("Synchronization")

        Log.d(ASSERTION_TAG, "Assert that the Offline Sync Settings page is displayed correctly.")
        offlineSyncSettingsPage.assertPageObjects()

        Log.d(ASSERTION_TAG, "Assert that the Offline Sync Settings frequency text is 'Weekly' (because we set it previously) and the 'Sync Content Wi-Fi Only' switch is switched off.")
        offlineSyncSettingsPage.assertSyncFrequencyLabelText(R.string.weekly)
        offlineSyncSettingsPage.assertWifiOnlySwitchIsNotChecked()
    }
