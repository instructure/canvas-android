...
class FileUtilsTest : Assert() {
    ...
    fun `getFileIcon with image contentType results in image icon`() {
        assertEquals(R.drawable.vd_utils_image, FileUtils.getFileIcon("filename.jpg", "image"))
    }
    ...
    fun `getFileIcon with video star contentType results in media icon`() {
        assertEquals(R.drawable.vd_utils_media, FileUtils.getFileIcon("filename.mp4", "video/*"))
    }
    ...
    fun `getFileIcon with audio contentType results in audio icon`() {
        assertEquals(R.drawable.vd_utils_audio, FileUtils.getFileIcon("filename.mp3", "audio"))
    }
    ...
    fun `getFileIcon with doc extension results in doc icon`() {
        assertEquals(R.drawable.vd_utils_document, FileUtils.getFileIcon("filename.doc", ""))
    }
    @Test
    fun `getFileIcon with docx extension results in doc icon`() {
        assertEquals(R.drawable.vd_utils_document, FileUtils.getFileIcon("filename.docx", ""))
    }
    @Test
    fun `getFileIcon with txt extension results in doc icon`() {
        assertEquals(R.drawable.vd_utils_document, FileUtils.getFileIcon("filename.txt", ""))
    }
    @Test
    fun `getFileIcon with rtf extension results in doc icon`() {
        assertEquals(R.drawable.vd_utils_document, FileUtils.getFileIcon("filename.rtf", ""))
    }
    @Test
    fun `getFileIcon with pdf extension results in doc icon`() {
        assertEquals(R.drawable.vd_utils_document, FileUtils.getFileIcon("filename.pdf", ""))
    }
    @Test
    fun `getFileIcon with xls extension results in doc icon`() {
        assertEquals(R.drawable.vd_utils_document, FileUtils.getFileIcon("filename.xls", ""))
    }
    ...
    fun `getFileIcon with zip extension results in attachment icon`() {
        assertEquals(R.drawable.vd_utils_attachment, FileUtils.getFileIcon("filename.zip", ""))
    }
    @Test
    fun `getFileIcon with tar extension results in attachment icon`() {
        assertEquals(R.drawable.vd_utils_attachment, FileUtils.getFileIcon("filename.tar", ""))
    }
    @Test
    fun `getFileIcon with 7z extension results in attachment icon`() {
        assertEquals(R.drawable.vd_utils_attachment, FileUtils.getFileIcon("filename.7z", ""))
    }
    @Test
    fun `getFileIcon with apk extension results in attachment icon`() {
        assertEquals(R.drawable.vd_utils_attachment, FileUtils.getFileIcon("filename.apk", ""))
    }
    @Test
    fun `getFileIcon with jar extension results in attachment icon`() {
        assertEquals(R.drawable.vd_utils_attachment, FileUtils.getFileIcon("filename.jar", ""))
    }
    @Test
    fun `getFileIcon with rar extension results in attachment icon`() {
        assertEquals(R.drawable.vd_utils_attachment, FileUtils.getFileIcon("filename.rar", ""))
    }
    // endregion compressed/etc extensions

    @Test
    fun `getFileIcon with empty filename results in attachment icon`() {
        assertEquals(R.drawable.vd_utils_attachment, FileUtils.getFileIcon("", ""))
    }
