...
class AssignmentReminderE2ETest: ParentComposeTest() {
    ...
    fun testAssignmentCustomReminderE2E() {
        ...
        assignmentReminderPage.selectDate(reminderDateOneHour)
        assignmentReminderPage.selectTime(reminderDateOneHour)

        Log.d(ASSERTION_TAG, "Assert that the reminder has been picked up and displayed on the Assignment Details Page.")
        assignmentReminderPage.assertReminderDisplayedWithText(reminderDateOneHour.time.toFormattedString())
        ...
        assignmentReminderPage.removeReminderWithText(reminderDateOneHour.time.toFormattedString())

        Log.d(ASSERTION_TAG, "Assert that the '1 Hour Before' reminder is not displayed any more.")
        assignmentReminderPage.assertReminderNotDisplayedWithText(reminderDateOneHour.time.toFormattedString())
        ...
        assignmentReminderPage.clickCustomReminderOption()
        assignmentReminderPage.selectDate(reminderDateOneWeek)
        assignmentReminderPage.selectTime(reminderDateOneWeek)

        Log.d(ASSERTION_TAG, "Assert that a toast message is occurring which warns that we cannot pick up a reminder which has already passed (for example cannot pick '1 Week Before' reminder for an assignment which ends tomorrow).")
        assignmentReminderPage.assertReminderNotDisplayedWithText(reminderDateOneWeek.time.toFormattedString())
        ...
        assignmentReminderPage.selectTime(reminderDateOneDay)

        Log.d(ASSERTION_TAG, "Assert that the reminder has been picked up and displayed on the Assignment Details Page.")
        assignmentReminderPage.assertReminderDisplayedWithText(reminderDateOneDay.time.toFormattedString())
    ...
    fun testAssignmentBeforeReminderE2E() {
        ...
        val reminderDateOneHour = futureDueDate.apply { add(Calendar.HOUR, -1) }
        Log.d(STEP_TAG, "Select '1 Hour Before'.")
        assignmentReminderPage.clickBeforeReminderOption("1 Hour Before")
        ...
        val reminderDateOneWeek = futureDueDate.apply { add(Calendar.WEEK_OF_YEAR, -1) }
        Log.d(STEP_TAG, "Select '1 Week Before'.")
        assignmentReminderPage.clickBeforeReminderOption("1 Week Before")
        ...
        Log.d(STEP_TAG, "Select '1 Day Before'.")
        assignmentReminderPage.clickBeforeReminderOption("1 Day Before")
