...
class LegalPageTest : ParentTest() {
    ...
    @Test
    @Ditto
    fun assertDisplaysPrivacyPolicy() {
        goToLegalPage()
        legalPage.clickPrivacyPolicy()
        legalPage.assertDisplaysPrivacyPolicy()
    }

    @Test
    @Ditto
    fun assertDisplaysTermsOfUse() {
        goToLegalPage()
        legalPage.clickTermsOfUse()
        legalPage.assertDisplaysTermsOfUse()
    }
    ...
    private fun goToLegalPage(): SeedApi.SeededParentDataApiModel {
