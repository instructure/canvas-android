...
public interface AttendanceListView extends SyncManager<Attendance> {
    ...
    void updateMarkAllButton(boolean atLeastOneMarkedPresentLateOrAbsent);
    void updateMarkAllButtonVisibility(boolean visible);
    void addSectionMenu(Section selectedSection, List<Section> sections);
