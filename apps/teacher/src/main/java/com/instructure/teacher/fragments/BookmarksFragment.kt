...
class BookmarksFragment /*: BaseSyncFragment<Bookmark, BookmarkListPresenter, BookmarksListView, BookmarkViewHolder, BookmarksListRecyclerAdapter>(),
    BookmarkListView, Bookmarkable*/ {
