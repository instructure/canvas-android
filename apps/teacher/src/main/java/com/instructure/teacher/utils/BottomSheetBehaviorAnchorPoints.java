...
public class BottomSheetBehaviorAnchorPoints<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public BottomSheetBehaviorAnchorPoints() { }
     ...
     */
    public BottomSheetBehaviorAnchorPoints(Context context, AttributeSet attrs ) {
        super( context, attrs );
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.google.android.material.R.styleable.BottomSheetBehavior_Layout);
        setPeekHeight(a.getDimensionPixelSize(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, 0));
        ...
        a = context.obtainStyledAttributes(attrs, R.styleable.CustomBottomSheetBehaviorAnchorPoints);
        if (attrs != null)
            mAnchorPoint = (int) a.getDimension( R.styleable.CustomBottomSheetBehaviorAnchorPoints_anchorPoint, 0);
        a.recycle();
    ...
    public final void setState( @State int state ) {
        ...
        if ( mViewRef == null ) {
             ...
             */
            if ( state == STATE_COLLAPSED || state == STATE_EXPANDED || state == STATE_ANCHOR_POINT || (mHideable && state == STATE_HIDDEN)) {
                mState = state;
...
//            mCallback.onStateChanged(bottomSheet, state);
    ...
    /**
     * A utility function to get the {@link BottomSheetBehaviorAnchorPoints} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BottomSheetBehaviorAnchorPoints}.
     * @return The {@link BottomSheetBehaviorAnchorPoints} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> BottomSheetBehaviorAnchorPoints<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BottomSheetBehaviorAnchorPoints)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehaviorAnchorPoints");
        }
        return (BottomSheetBehaviorAnchorPoints<V>) behavior;
    }
}
