...
class   ModulesE2ETest : TeacherTest() {
    ...
    fun testModulesE2E() {
        ...
        assignmentDetailsPage.moduleItem.assertModuleNameDisplayed(module.name)
        ...
        assignmentDetailsPage.moduleItem.assertPreviousArrowNotDisplayed()
        assignmentDetailsPage.moduleItem.assertNextArrowDisplayed()
        ...
        assignmentDetailsPage.moduleItem.clickOnNextArrow()
        quizDetailsPage.assertQuizDetails(quiz)
        quizDetailsPage.moduleItem.assertModuleNameDisplayed(module.name)

        Log.d(STEP_TAG, "Assert that both the previous and next arrow buttons are displayed.")
        quizDetailsPage.moduleItem.assertPreviousArrowDisplayed()
        quizDetailsPage.moduleItem.assertNextArrowDisplayed()
        ...
        quizDetailsPage.moduleItem.clickOnNextArrow()
        editPageDetailsPage.assertPageDetails(testPage)
        editPageDetailsPage.moduleItem.assertModuleNameDisplayed(module.name)

        Log.d(STEP_TAG, "Assert that both the previous and next arrow buttons are displayed.")
        editPageDetailsPage.moduleItem.assertPreviousArrowDisplayed()
        editPageDetailsPage.moduleItem.assertNextArrowDisplayed()
        ...
        editPageDetailsPage.moduleItem.clickOnNextArrow()
        discussionsDetailsPage.assertDiscussionTitle(discussionTopic.title)
        discussionsDetailsPage.assertDiscussionPublished()
        discussionsDetailsPage.moduleItem.assertModuleNameDisplayed(module.name)
        ...
        discussionsDetailsPage.moduleItem.assertPreviousArrowDisplayed()
        discussionsDetailsPage.moduleItem.assertNextArrowNotDisplayed()
        ...
        quizDetailsPage.moduleItem.clickOnPreviousArrow()
        editPageDetailsPage.assertPageDetails(testPage)
        editPageDetailsPage.moduleItem.assertModuleNameDisplayed(module.name)
