...
class DiscussionRouteHelperTeacherNetworkDataSourceTest {
    ...
    private val dataSource = DiscussionRouteHelperTeacherNetworkDataSource(discussionApi, groupApi, featuresApi, featureFlagProvider)
