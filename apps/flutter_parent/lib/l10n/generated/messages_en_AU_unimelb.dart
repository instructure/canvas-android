...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m14(threshold) => "Subject Grade Above ${threshold}";

  static m15(threshold) => "Subject Grade Below ${threshold}";
  ...
  static m23(grade) => "Final Grade: ${grade}";
  ...
  static m41(studentName) => "Regarding: ${studentName}, Subject Overview";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Tap to favorite the courses you want to see on the Calendar." : MessageLookupByLibrary.simpleMessage("Tap to favourite the subjects you want to see on the Calendar."),
    ...
    "There was an error loading your your student’s courses." : MessageLookupByLibrary.simpleMessage("There was an error loading your student’s subjects."),
    ...
    "Your student’s courses might not be published yet." : MessageLookupByLibrary.simpleMessage("Your student’s subjects might not be published yet."),
