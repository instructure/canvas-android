...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(userName) => "您正在临时代理${userName}";

  static m1(version) => "v. ${version}";

  static m2(threshold) => "作业评分高于${threshold}";

  static m3(threshold) => "作业评分低于${threshold}";

  static m4(moduleName) => "此作业已被模块“${moduleName}”锁定。";

  static m5(studentName, assignmentName) => "事由：${studentName}，作业 - ${assignmentName}";

  static m6(points) => "${points} 分";

  static m7(points) => "${points} 分";

  static m8(authorName, howMany) => "${Intl.plural(howMany, one: '${authorName}至另外1个', other: '${authorName}至另外${howMany}个')}";

  static m9(authorName, recipientName) => "${authorName} 至 ${recipientName}";

  static m10(authorName, recipientName, howMany) => "${Intl.plural(howMany, one: '${authorName}至${recipientName}和另外1个', other: '${authorName}至${recipientName}和另外${howMany}个')}";

  static m11(count) => "${count}+";

  static m12(studentName) => "更改 ${studentName} 的颜色";

  static m13(score, pointsPossible) => "得分 ${score}，总分 ${pointsPossible}";

  static m14(studentShortName) => "适用于${studentShortName}";

  static m15(threshold) => "课程评分高于${threshold}";

  static m16(threshold) => "课程评分低于${threshold}";

  static m17(date, time) => "${date}，时间 ${time}";

  static m18(alertTitle) => "拒绝 ${alertTitle}";

  static m19(canvasGuides, canvasSupport) => "尝试搜索您要访问的学校或校区的名称，例如“Smith Private School”或“Smith County Schools”。也可以直接输入Canvas域，例如“smith.instructure.com”。\n\n有关查找机构Canvas账户的更多信息，可访问${canvasGuides}、联系${canvasSupport}或您的学校寻求帮助。";

  static m20(date, time) => "截止于 ${date}，${time}";

  static m21(userName) => "您将停止临时代理用户 ${userName} 并注销。";

  static m22(userName) => "您将停止临时代理用户 ${userName} 并返回您的原始帐户。";

  static m23(studentName, eventTitle) => "事由：${studentName}，活动 - ${eventTitle}";

  static m24(startAt, endAt) => "${startAt} - ${endAt}";

  static m25(grade) => "最终评分：${grade}";

  static m26(studentName) => "事由：${studentName}，首页";

  static m27(score, pointsPossible) => "${score}/${pointsPossible}";

  static m28(studentName) => "事由：${studentName}，评分";

  static m29(pointsLost) => "迟交罚分 (-${pointsLost})";

  static m30(studentName, linkUrl) => "事由：${studentName}，${linkUrl}";

  static m31(percentage) => "必须高于${percentage}";

  static m32(percentage) => "必须低于${percentage}";

  static m33(month) => "下个月：${month}";

  static m34(date) => "下周，从${date}开始";

  static m35(query) => "找不到与“${query}”匹配的学校";

  static m36(points, howMany) => "${Intl.plural(howMany, one: '共1分', other: '共${points}分')}";

  static m37(count) => "+${count}";

  static m38(points) => "${points}满分";

  static m39(month) => "上个月：${month}";

  static m40(date) => "上周，从${date}开始";

  static m41(termsOfService, privacyPolicy) => "点击“创建帐户”即表示，您同意${termsOfService}并确认${privacyPolicy}";

  static m42(version) => "Android 版本建议 - Canvas Parent ${version}";

  static m43(month) => "${month}月";

  static m44(position) => "${Intl.plural(position, one: '${position} 星', other: '${position} 星')}";

  static m45(date, time) => "此作业提交时间为${date}，${time}，正在等待评分";

  static m46(studentName) => "事由：${studentName}，教学大纲";

  static m47(count) => "${count}未读";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "A network error occurred when adding this student. Check your connection and try again." : MessageLookupByLibrary.simpleMessage("添加此学生时发生网络错误。请检查您的网络连接并重试。"),
    "A subject is required." : MessageLookupByLibrary.simpleMessage("必须填写主题。"),
    "Act As User" : MessageLookupByLibrary.simpleMessage("临时代理用户"),
    ...
    "Already have an account? " : MessageLookupByLibrary.simpleMessage("已经有一个帐户吗？ "),
    ...
    "An error occurred while saving your selection. Please try again." : MessageLookupByLibrary.simpleMessage("保存选择时发生错误。请重试。"),
    ...
    "Barney, Fuschia" : MessageLookupByLibrary.simpleMessage("粉红"),
    "Calendars" : MessageLookupByLibrary.simpleMessage("日历"),
    "Camera Permission" : MessageLookupByLibrary.simpleMessage("相机权限"),
    ...
    "Create Account" : MessageLookupByLibrary.simpleMessage("创建帐户"),
    ...
    "Domain:" : MessageLookupByLibrary.simpleMessage("域："),
    "Don\'t show again" : MessageLookupByLibrary.simpleMessage("不再显示"),
    ...
    "Electric, blue" : MessageLookupByLibrary.simpleMessage("蓝色"),
    ...
    "Expired QR Code" : MessageLookupByLibrary.simpleMessage("失效的二维码"),
    ...
    "Fire, Orange" : MessageLookupByLibrary.simpleMessage("橙色"),
    ...
    "Go to today" : MessageLookupByLibrary.simpleMessage("转至今天"),
    ...
    "Hide Password" : MessageLookupByLibrary.simpleMessage("隐藏密码"),
    "High Contrast Mode" : MessageLookupByLibrary.simpleMessage("高对比度模式"),
    "How are we doing?" : MessageLookupByLibrary.simpleMessage("我们做得怎样？"),
    ...
    "I don\'t have a Canvas account" : MessageLookupByLibrary.simpleMessage("我没有 Canvas 帐户"),
    "I have a Canvas account" : MessageLookupByLibrary.simpleMessage("我有 Canvas 帐户"),
    ...
    "Incorrect Domain" : MessageLookupByLibrary.simpleMessage("错误的域"),
    ...
    "Interactions on this page are limited by your institution." : MessageLookupByLibrary.simpleMessage("在此页面上的互动被您的机构限制。"),
    "Invalid QR Code" : MessageLookupByLibrary.simpleMessage("无效的二维码"),
    ...
    "Locate QR Code" : MessageLookupByLibrary.simpleMessage("查找二维码"),
    ...
    "Login flow: Canvas" : MessageLookupByLibrary.simpleMessage("登录流程：Canvas"),
    "Login flow: Normal" : MessageLookupByLibrary.simpleMessage("登录流程：正常"),
    "Login flow: Site Admin" : MessageLookupByLibrary.simpleMessage("登录流程：网站管理员"),
    "Login flow: Skip mobile verify" : MessageLookupByLibrary.simpleMessage("登录流程：跳过移动设备验证"),
    ...
    "Open Canvas Student" : MessageLookupByLibrary.simpleMessage("打开 Canvas 学生版"),
    ...
    "Password is required" : MessageLookupByLibrary.simpleMessage("必须填写密码"),
    "Password must contain at least 8 characters" : MessageLookupByLibrary.simpleMessage("密码必须包含至少 8 个字符"),
    "Password…" : MessageLookupByLibrary.simpleMessage("密码..."),
    "Planner Note" : MessageLookupByLibrary.simpleMessage("计划程序注释"),
    "Please enter a valid email address" : MessageLookupByLibrary.simpleMessage("请输入有效的电子邮件地址"),
    "Please enter an email address" : MessageLookupByLibrary.simpleMessage("请输入电子邮件地址"),
    "Please enter full name" : MessageLookupByLibrary.simpleMessage("请输入全名"),
    "Please scan a QR code generated by Canvas" : MessageLookupByLibrary.simpleMessage("请扫描 Canvas 生成的二维码"),
    "Plum, Purple" : MessageLookupByLibrary.simpleMessage("紫色"),
    ...
    "Privacy Policy Link" : MessageLookupByLibrary.simpleMessage("隐私政策链接"),
    ...
    "QR scanning requires camera access" : MessageLookupByLibrary.simpleMessage("扫描二维码要求具有相机访问权限"),
    "Raspberry, Red" : MessageLookupByLibrary.simpleMessage("红色"),
    ...
    "Reminders have changed!" : MessageLookupByLibrary.simpleMessage("提醒已更改！"),
    ...
    "Screenshot showing location of QR code generation in browser" : MessageLookupByLibrary.simpleMessage("在浏览器中显示二维码生成位置的截图"),
    "Screenshot showing location of pairing QR code generation in the Canvas Student app" : MessageLookupByLibrary.simpleMessage("截图显示在 Canvas 学生版应用程序中生成配对二维码的位置"),
    "Select" : MessageLookupByLibrary.simpleMessage("选择"),
    "Select Student Color" : MessageLookupByLibrary.simpleMessage("选择学生颜色"),
    "Select recipients" : MessageLookupByLibrary.simpleMessage("选择收件人"),
    "Send Feedback" : MessageLookupByLibrary.simpleMessage("发送反馈"),
    ...
    "Shamrock, Green" : MessageLookupByLibrary.simpleMessage("绿色"),
    "Share Your Love for the App" : MessageLookupByLibrary.simpleMessage("分享您所喜爱的应用程序"),
    "Show Password" : MessageLookupByLibrary.simpleMessage("显示密码"),
    "Sign In" : MessageLookupByLibrary.simpleMessage("登录"),
    "Something went wrong trying to create your account, please reach out to your school for assistance." : MessageLookupByLibrary.simpleMessage("尝试创建帐户时遇到错误，请联系您的学校寻求帮助。"),
    ...
    "Stop Acting as User" : MessageLookupByLibrary.simpleMessage("停止临时代理用户"),
    "Student" : MessageLookupByLibrary.simpleMessage("学生"),
    "Student Pairing" : MessageLookupByLibrary.simpleMessage("学生配对"),
    "Students can create a QR code using the Canvas Student app on their mobile device" : MessageLookupByLibrary.simpleMessage("学生可以使用移动设备上的 Canvas 学生版应用程序创建二维码"),
    "Students can obtain a pairing code through the Canvas website" : MessageLookupByLibrary.simpleMessage("学生可以通过 Canvas 网站获得配对码"),
    ...
    "Tap to favorite the courses you want to see on the Calendar. Select up to 10." : MessageLookupByLibrary.simpleMessage("点击以收藏您希望在日历中看到的课程。选择最多 10 个。"),
    ...
    "Terms of Service" : MessageLookupByLibrary.simpleMessage("服务条款"),
    "Terms of Service Link" : MessageLookupByLibrary.simpleMessage("服务条款链接"),
    "Terms of Use" : MessageLookupByLibrary.simpleMessage("使用条款"),
    "The QR code you scanned may have expired. Refresh the code on the student\'s device and try again." : MessageLookupByLibrary.simpleMessage("您扫描的二维码已失效。刷新学生设备上的二维码并重试。"),
    ...
    "The student you are trying to add belongs to a different school. Log in or create an account with that school to scan this code." : MessageLookupByLibrary.simpleMessage("您尝试添加的学生属于不同的学校。使用该学校的帐户登录或创建帐户以扫描此二维码。"),
    ...
    "There was a problem removing this student from your account. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("从帐户中移除该学生时发生错误。请检查您的连接，然后再试一次。"),
    ...
    "There was an error loading your student’s courses." : MessageLookupByLibrary.simpleMessage("加载学生的课程时发生错误。"),
    "There was an error logging in. Please generate another QR Code and try again." : MessageLookupByLibrary.simpleMessage("登录时发生错误。请生成新的二维码并重试。"),
    "There was an error trying to act as this user. Please check the Domain and User ID and try again." : MessageLookupByLibrary.simpleMessage("尝试临时代理用户时发生错误。请检查域和用户 ID，然后再试一次。"),
    ...
    "This will unpair and remove all enrollments for this student from your account." : MessageLookupByLibrary.simpleMessage("这样做将取消配对并从您的帐户中移除该学生的所有注册。"),
    ...
    "Use Dark Theme in Web Content" : MessageLookupByLibrary.simpleMessage("在 Web 内容中使用深色主题"),
    "User ID" : MessageLookupByLibrary.simpleMessage("用户 ID"),
    "User ID:" : MessageLookupByLibrary.simpleMessage("用户 ID："),
    "Version Number" : MessageLookupByLibrary.simpleMessage("版本号"),
    "View Description" : MessageLookupByLibrary.simpleMessage("查看说明"),
    "View error details" : MessageLookupByLibrary.simpleMessage("查看错误详细信息"),
    "View the Privacy Policy" : MessageLookupByLibrary.simpleMessage("查看隐私政策"),
    ...
    "What can we do better?" : MessageLookupByLibrary.simpleMessage("我们如何能做得更好？"),
    "Yes" : MessageLookupByLibrary.simpleMessage("是"),
    "You are not observing any students." : MessageLookupByLibrary.simpleMessage("您未观察任何学生。"),
    "You may only choose 10 calendars to display" : MessageLookupByLibrary.simpleMessage("只能选择 10 个要显示的日历"),
    "You must enter a user id" : MessageLookupByLibrary.simpleMessage("必须输入用户 ID"),
    "You must enter a valid domain" : MessageLookupByLibrary.simpleMessage("必须输入有效的域"),
    "You must select at least one calendar to display" : MessageLookupByLibrary.simpleMessage("必须选择至少 1 个要显示的日历"),
    ...
    "You\'ll find the QR code on the web in your account profile. Click \'QR for Mobile Login\' in the list." : MessageLookupByLibrary.simpleMessage("在 Web 的帐户个人资料中可以找到二维码。点击列表中的“用于移动设备登录的二维码”。"),
    "You\'ll need to open your student\'s Canvas Student app to continue. Go into Main Menu > Settings > Pair with Observer and scan the QR code you see there." : MessageLookupByLibrary.simpleMessage("您需打开学生的 Canvas 学生版应用程序才能继续。转到“主菜单 > 设置 > 与旁听者配对”，扫描在其中看到的二维码。"),
