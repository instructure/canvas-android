...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m15(threshold) => "Kursuskarakter oven ${threshold}";

  static m16(threshold) => "Kursuskarakter under ${threshold}";
  ...
  static m25(grade) => "Endelig karakter: ${grade}";
  ...
  static m46(studentName) => "Vedrørende: ${studentName}, Læseplan";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "A network error occurred when adding this student. Check your connection and try again." : MessageLookupByLibrary.simpleMessage("Der opstod en netværksfejl under dit forsøg på at tilføje denne studerende. Kontrollér forbindelsen, og prøv igen."),
    ...
    "Add student with…" : MessageLookupByLibrary.simpleMessage("Tilføj studerende med ..."),
    ...
    "All Grading Periods" : MessageLookupByLibrary.simpleMessage("Alle karakterperioder"),
    ...
    "An unexpected error occurred" : MessageLookupByLibrary.simpleMessage("En uventet fejl opstod"),
    ...
    "Are you a student or teacher?" : MessageLookupByLibrary.simpleMessage("Er du studerende eller lærer?"),
    ...
    "Assignment grade above" : MessageLookupByLibrary.simpleMessage("Opgavekarakter over"),
    "Assignment grade below" : MessageLookupByLibrary.simpleMessage("Opgavekarakter under"),
    "Assignment missing" : MessageLookupByLibrary.simpleMessage("Opgave mangler"),
    ...
    "Canvas Student" : MessageLookupByLibrary.simpleMessage("Canvas-studerende"),
    ...
    "Course grade above" : MessageLookupByLibrary.simpleMessage("Kursuskarakter over"),
    "Course grade below" : MessageLookupByLibrary.simpleMessage("Kursuskarakter under"),
    ...
    "Email Address" : MessageLookupByLibrary.simpleMessage("E-mailadresse"),
    "Email:" : MessageLookupByLibrary.simpleMessage("E-mail:"),
    "Email…" : MessageLookupByLibrary.simpleMessage("E-mail ..."),
    "Enter the student pairing code provided to you. If the pairing code doesn\'t work, it may have expired" : MessageLookupByLibrary.simpleMessage("Indtast den studerendes parringskode, der er blevet givet til dig. Hvis parringskoden ikke fungerer, kan den være udløbet"),
    ...
    "Filter by" : MessageLookupByLibrary.simpleMessage("Filtrer efter"),
    ...
    "Grade percentage" : MessageLookupByLibrary.simpleMessage("Karakter procent"),
    ...
    "I can\'t get things done until I hear back from you." : MessageLookupByLibrary.simpleMessage("Jeg kan ikke udføre ting før jeg har fået dit svar."),
    ...
    "No Students" : MessageLookupByLibrary.simpleMessage("Ingen studerende"),
    ...
    "Open Canvas Student" : MessageLookupByLibrary.simpleMessage("Åbn Canvas Student-appen"),
    ...
    "Screenshot showing location of pairing QR code generation in the Canvas Student app" : MessageLookupByLibrary.simpleMessage("Skærmbillede, der viser placering af QR-koden i Canvas Student-appen"),
    "Select" : MessageLookupByLibrary.simpleMessage("Vælg"),
    "Select Student Color" : MessageLookupByLibrary.simpleMessage("Vælg den studerendes farve"),
    ...
    "Student" : MessageLookupByLibrary.simpleMessage("Studerende"),
    "Student Pairing" : MessageLookupByLibrary.simpleMessage("Parring af konti for studerende"),
    "Students can create a QR code using the Canvas Student app on their mobile device" : MessageLookupByLibrary.simpleMessage("Studerende kan oprette en QR-kode ved hjælp af Canvas Student-appen på deres mobilenhed"),
    "Students can obtain a pairing code through the Canvas website" : MessageLookupByLibrary.simpleMessage("Studerende kan få en parringskode via Canvas-webstedet"),
    ...
    "Syllabus" : MessageLookupByLibrary.simpleMessage("Læseplan"),
    ...
    "Tap to pair with a new student" : MessageLookupByLibrary.simpleMessage("Tryk for at parre med en ny studerende"),
    "Tap to select this student" : MessageLookupByLibrary.simpleMessage("Tryk for at vælge denne studerende"),
    "Tap to show student selector" : MessageLookupByLibrary.simpleMessage("Tryk for at vise vælger for studerende"),
    "Teacher" : MessageLookupByLibrary.simpleMessage("Lærer"),
    ...
    "The QR code you scanned may have expired. Refresh the code on the student\'s device and try again." : MessageLookupByLibrary.simpleMessage("Den QR-kode, du scannede, kan være udløbet. Opdater koden på den studerendes enhed, og prøv igen."),
    ...
    "The student you are trying to add belongs to a different school. Log in or create an account with that school to scan this code." : MessageLookupByLibrary.simpleMessage("Den studerende, du prøver at tilføje, tilhører en anden skole. Log ind eller opret en konto med denne skole for at scanne denne kode."),
    ...
    "There was a problem removing this student from your account. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("Der opstod et problem under forsøg på at fjerne denne studerende fra din konto. Kontrollér forbindelsen, og prøv igen."),
    ...
    "There was an error loading your student\'s alerts." : MessageLookupByLibrary.simpleMessage("Der opstod en fejl under indlæsning af den studerendes varslinger."),
    ...
    "There was an error loading your student’s courses." : MessageLookupByLibrary.simpleMessage("Der opstod en fejl under indlæsning af din studerendes fag."),
    ...
    "This will unpair and remove all enrollments for this student from your account." : MessageLookupByLibrary.simpleMessage("Dette vil fjerne parring og alle tilmeldinger for denne studerende fra din konto."),
    "Total Grade" : MessageLookupByLibrary.simpleMessage("Total karakter"),
    ...
    "We couldn\'t find any students associated with this account" : MessageLookupByLibrary.simpleMessage("Vi kunne ikke finde nogen studerende tilknyttet den konto."),
    ...
    "You\'ll need to open your student\'s Canvas Student app to continue. Go into Main Menu > Settings > Pair with Observer and scan the QR code you see there." : MessageLookupByLibrary.simpleMessage("Du skal åbne din studerendes Canvas Student-app for at fortsætte. Gå til Hovedmenu > Indstillinger> Par med observatør, og scan den QR-kode, du ser der."),
