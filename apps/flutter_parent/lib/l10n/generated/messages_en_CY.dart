...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(moduleName) => "This assignment is locked by the unit \"${moduleName}\".";
  ...
  static m13(threshold) => "Module Grade Above ${threshold}";

  static m14(threshold) => "Module Grade Below ${threshold}";
