...
// This is a library that provides messages for a en_CY locale. All the
...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m4(moduleName) => "This assignment is locked by the unit \"${moduleName}\".";
  ...
  static m15(threshold) => "Module Grade Above ${threshold}";

  static m16(threshold) => "Module Grade Below ${threshold}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "Choose a course to message" : MessageLookupByLibrary.simpleMessage("Choose a module to message"),
    ...
    "Course Announcement" : MessageLookupByLibrary.simpleMessage("Module announcement"),
    "Course Announcements" : MessageLookupByLibrary.simpleMessage("Module announcements"),
    "Course grade above" : MessageLookupByLibrary.simpleMessage("Module mark above"),
    "Course grade below" : MessageLookupByLibrary.simpleMessage("Module mark below"),
    ...
    "No Courses" : MessageLookupByLibrary.simpleMessage("No modules"),
    ...
    "Send a message about this course" : MessageLookupByLibrary.simpleMessage("Send a message about this module"),
    ...
    "Tap to favorite the courses you want to see on the Calendar. Select up to 10." : MessageLookupByLibrary.simpleMessage("Tap to favourite the modules you want to see on the Calendar. Select up to 10."),
    ...
    "There was an error loading recipients for this course" : MessageLookupByLibrary.simpleMessage("There was an error loading recipients for this module"),
    "There was an error loading the summary details for this course." : MessageLookupByLibrary.simpleMessage("There was an error loading the summary details for this module."),
    ...
    "There was an error loading your student’s courses." : MessageLookupByLibrary.simpleMessage("There was an error loading your student’s modules."),
    ...
    "This course does not have any assignments or calendar events yet." : MessageLookupByLibrary.simpleMessage("This module does not have any assignments or calendar events yet."),
    ...
    "Unable to fetch courses. Please check your connection and try again." : MessageLookupByLibrary.simpleMessage("Unable to fetch modules. Please check your connection and try again."),
    ...
    "Your student’s courses might not be published yet." : MessageLookupByLibrary.simpleMessage("Your student’s modules might not be published yet."),
    ...
    "coursesLabel" : MessageLookupByLibrary.simpleMessage("Modules"),
    "dateAtTime" : m17,
