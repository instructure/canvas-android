...
part 'authenticated_url.g.dart';

/// To have this built_value be generated, run this command from the project root:
/// flutter pub run build_runner build --delete-conflicting-outputs
abstract class AuthenticatedUrl implements Built<AuthenticatedUrl, AuthenticatedUrlBuilder> {
  @BuiltValueSerializer(serializeNulls: true) // Add this line to get nulls to serialize when we convert to JSON
  static Serializer<AuthenticatedUrl> get serializer => _$authenticatedUrlSerializer;
  ...
  static void _initializeBuilder(AuthenticatedUrlBuilder b) => b..sessionUrl = '';
}
