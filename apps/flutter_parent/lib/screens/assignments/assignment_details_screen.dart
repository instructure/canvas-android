...
class AssignmentDetailsScreen extends StatefulWidget {
  ...
  const AssignmentDetailsScreen(
      {Key key, @required this.courseId, @required this.assignmentId, @required this.studentId})
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (context, AsyncSnapshot<AssignmentDetails> snapshot) => Scaffold(
        ...
        floatingActionButton: snapshot.hasData ? _fab() : null,
...
//    locator.get<QuickNav>().push(context, CreateConversationScreen());
  }
}
