...
# Borrowed from https://medium.com/@nocnoc/combined-code-coverage-for-flutter-and-dart-237b9563ecf8

# To run this locally, you will need to install the "lcov" tool.  "brew install lcov".
...
# Don't know why this was necessary, so I'm commenting it out.
