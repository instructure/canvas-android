...
void main() {
  ...
  testWidgetsWithAccessibilityChecks('Displays error state with retry', (tester) async {
    ...
    expect(find.text(l10n.genericLoadingErrorMessage(l10n.errorLoadingMessages)), findsOneWidget);
    ...
    expect(find.text(l10n.genericLoadingErrorMessage(l10n.errorLoadingMessages)), findsNothing);
